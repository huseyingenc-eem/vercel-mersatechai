  ...
  ({ className }: { className?: string }) => {
    ...
    return (
      ...
      >
        ...
        >
          {/* Base grid - Theme'e göre gri tonlar */}
          <path
          ...
          {/* Animated paths - Tema chart renkleri */}
          ...
          <defs>
            {paths.map((path, index) => (
              ...
              >
                ...
                {/* Dark mode - yine chart üzerinden ama daha açık tonlar */}
                <stop
            ...
            >
              {/* Light mode - muted / muted-foreground */}
              <stop
                className="dark:hidden"
                offset="0.0666667"
              ...
              {/* Dark mode - aynı değişkenlerin dark versiyonları */}
              <stop
                className="hidden dark:inline"
                offset="0.0666667"
                stopColor="hsl(var(--muted-foreground))"
